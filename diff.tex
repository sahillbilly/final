...
%DIF DEL old.tex   Mon Feb 19 08:07:14 2018
%DIF ADD new.tex   Mon Feb 19 15:29:48 2018
...
% 1st. author
\alignauthor
\DIFdelbegin \DIFdel{Mukesh Saini}\DIFdelend \DIFaddbegin \DIFadd{Sahil Kumar}\DIFaddend \\
       \affaddr{Dept. of Computer Science}\\
       \DIFdelbegin %DIFDELCMD < \affaddr{National University of Singapore}%%%
\DIFdelend \DIFaddbegin \affaddr{IIT ROPAR}\DIFaddend \\
       \DIFdelbegin %DIFDELCMD < \email{mksaini@comp.nus.edu.sg}
%DIFDELCMD < %%%
\DIFdelend \DIFaddbegin \email{2016csb1057@iitrpr.ac.in}
\DIFaddend % 2nd. author
\alignauthor
\DIFdelbegin \DIFdel{Raghudeep Gadde}\DIFdelend \DIFaddbegin \DIFadd{Sameer}\DIFaddend \\
       \DIFdelbegin %DIFDELCMD < \affaddr{Dept. of ECE}%%%
\DIFdelend \DIFaddbegin \affaddr{Dept. of CSE}\DIFaddend \\
       \DIFdelbegin %DIFDELCMD < \affaddr{National University of Singapore}%%%
\DIFdelend \DIFaddbegin \affaddr{IIT ROPAR}\DIFaddend \\
       \DIFdelbegin %DIFDELCMD < \email{elerdg@nus.edu.sg}
%DIFDELCMD < %%%
\DIFdelend \DIFaddbegin \email{2016csb1058@iitrpr.ac.in}
\DIFaddend \and
% 3rd. author
\alignauthor
\DIFdelbegin \DIFdel{Shuicheng Yan}\DIFdelend \DIFaddbegin \DIFadd{Akshat Rathore}\DIFaddend \\
       \DIFdelbegin %DIFDELCMD < \affaddr{Dept. of ECE}%%%
\DIFdelend \DIFaddbegin \affaddr{Dept. of CSE}\DIFaddend \\
       \DIFdelbegin %DIFDELCMD < \affaddr{National University of Singapore}%%%
\DIFdelend \DIFaddbegin \affaddr{IIT ROPAR}\DIFaddend \\
...
%DIFDELCMD <   %%%
\DIFdelend \DIFaddbegin \email{2016csb1030@iitrpr.ac.in}
  \DIFaddend % use '\and' if you need 'another row' of author names
% 4th. author
\alignauthor
\DIFdelbegin \DIFdel{Wei Tsang Ooi}\DIFdelend \DIFaddbegin \DIFadd{Shreyanshu Shekhar}\DIFaddend \\
       \affaddr{Dept. of Computer Science}\\
       \DIFdelbegin %DIFDELCMD < \affaddr{National University of Singapore}%%%
\DIFdelend \DIFaddbegin \affaddr{IIT ROPAR}\DIFaddend \\
       \DIFdelbegin %DIFDELCMD < \email{ooiwt@comp.nus.edu.sg}
%DIFDELCMD < %%%
\DIFdelend \DIFaddbegin \email{2016csb1060@iitrpr.ac.in}
\DIFaddend }
